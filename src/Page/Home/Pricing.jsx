...
const Pricing = () => {
  return (
    <section className="relative z-10 overflow-hidden bg-slate-200 pb-12 pt-20 dark:bg-dark lg:pb-[90px] lg:pt-[120px]">
        ...
        <div className="-mx-4 flex flex-wrap justify-center">
          <div className="-mx-4 flex flex-wrap">
            <PricingCard
              ...
              price="$1000"
              subscription="year"
              description="Perfect for live a One man"
              buttonText="Buy"
            >
              <List>1 Room</List>
              <List>Attach BathRoom</List>
              <List>Kitcen Room</List>
              <List>Free Wifi</List>
            ...
            <PricingCard
              ...
              price="$2000"
              subscription="month"
              description="Perfect for Live a Couple"
              buttonText="Buy"
              active
            >
              <List>2 Room</List>
              <List>Attach Bathroom</List>
              <List>Kitchen & Dining room </List>
              <List>Free Wifi</List>
            ...
            <PricingCard
              ...
              price="$3000"
              subscription="year"
              description="Perfect for Live a Family"
              buttonText="Buy"
            >
              <List>4 Room</List>
              <List>two BathROOm</List>
              <List>Swiming pull & playGround</List>
              <List>Free Electicity</List>
